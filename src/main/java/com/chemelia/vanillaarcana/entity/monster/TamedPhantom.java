...
public class TamedPhantom extends Phantom implements SummonedEntity {
  public TamedPhantom(EntityType<? extends TamedPhantom> type, Level world) {
      super(type, world);
  }

  public TamedPhantom(EntityType<? extends TamedPhantom> type, Level world, Player player){
     this(type, world);
     tame(player);
  }
  ...
  protected void registerGoals(){
   super.registerGoals();
   this.goalSelector.addGoal(4, new FollowSummonerGoal(this, 1.0D, 10.0F, 2.0F, true));
  ...
  public boolean canBeAffected(MobEffectInstance effect){
   ...
   protected boolean shouldDropLoot(){
    ...
    protected static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(TamedPhantom.class, EntityDataSerializers.BYTE);
    protected static final EntityDataAccessor<Optional<UUID>> DATA_OWNERUUID_ID = SynchedEntityData.defineId(TamedPhantom.class, EntityDataSerializers.OPTIONAL_UUID);
