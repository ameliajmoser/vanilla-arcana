...
public class TamedWitherSkeleton extends WitherSkeleton implements SummonedEntity {
  ...
  public boolean canBeAffected(MobEffectInstance effect){
   ...
   protected boolean shouldDropLoot(){
    ...
    protected static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(TamedWitherSkeleton.class, EntityDataSerializers.BYTE);
    protected static final EntityDataAccessor<Optional<UUID>> DATA_OWNERUUID_ID = SynchedEntityData.defineId(TamedWitherSkeleton.class, EntityDataSerializers.OPTIONAL_UUID);
