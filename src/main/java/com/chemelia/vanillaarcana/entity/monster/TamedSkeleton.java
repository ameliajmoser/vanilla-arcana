...
public class TamedSkeleton extends AbstractSkeleton implements SummonedEntity {
...
protected void dropCustomDeathLoot(DamageSource pSource, int pLooting, boolean pRecentlyHit) {
   ...
   protected boolean shouldDropLoot(){
    ...
    protected static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(TamedSkeleton.class, EntityDataSerializers.BYTE);
    protected static final EntityDataAccessor<Optional<UUID>> DATA_OWNERUUID_ID = SynchedEntityData.defineId(TamedSkeleton.class, EntityDataSerializers.OPTIONAL_UUID);
