...
public class TamedVex extends Vex implements OwnableEntity {

   public TamedVex(EntityType<? extends TamedVex> p_33984_, Level p_33985_) {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new TamedVex.VexChargeAttackGoal());
      this.goalSelector.addGoal(8, new TamedVex.VexRandomMoveGoal());
